                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (loggedIn) {
                                        context.pushNamed('schedule_screen');
                                      } else {
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(48, 0, 48, 24),
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(20),
                          child: Container(
                            height: 400,
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, teacherItemIndex) {
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'ncf4ys6n' /* Installment education */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .title1,
                                          ),
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'zqcyfdhq' /* We will teach you to feel
 con... */
                                                    ,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'eay3fysw' /* Call, discuss all the conditio... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .subtitle1,
                                          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'bmlqnbnh' /* Contact us in a convenient way... */,
                                  ),
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await launchURL(
                                        'https://wa.me/+996500353541/?text=Здравствуйте, можно ли записаться на занятия в автошколу?');
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    'itkdwbfg' /* Whatsapp */,
                                  ),
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await launchURL(
                                        'https://www.instagram.com/djal_auto/');
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    'ttezl4no' /* Instagram */,
                                  ),
