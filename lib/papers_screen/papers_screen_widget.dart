                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'oc9mwrrp' /* Choose exam paper */,
                        ),
                        style: FlutterFlowTheme.of(context).title1,
                      ),
                    ),
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(24, 8, 0, 24),
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'ynmb8cg7' /* Category ABM */,
                        ),
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future: (_apiRequestCompleter ??= Completer<
                                ApiCallResponse>()
                              ..complete(PapersFirebaseRealtimeDBCall.call()))
                            .future,
                              ...
                              return RefreshIndicator(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder: (context, paperIdIndex) {
                                    final paperIdItem = paperId[paperIdIndex];
                                    return InkWell(
                                      onTap: () async {
                                        singlePaperData =
                                      ...
                                      child: PaperButtonWidget(
                                        key: Key('paperButton_${paperIdIndex}'),
