...
class AppStateNotifier extends ChangeNotifier {
  DjalautoFirebaseUser? initialUser;
  DjalautoFirebaseUser? user;
  ...
  void update(DjalautoFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'papersScreen',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'papers_screen')
                  : PapersScreenWidget(
                      plus1: params.getParam('plus1', ParamType.int),
                    ),
            ),
            FFRoute(
              name: 'account_screen',
